...
import { idlFactory } from './gsp_ledger.did.js';
export { idlFactory } from './gsp_ledger.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GSP_LEDGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gsp_ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gsp_ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gsp_ledger.did.js")._SERVICE>}
 */
export const gsp_ledger = createActor(canisterId);
