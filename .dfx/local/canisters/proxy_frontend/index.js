...
import { idlFactory } from './proxy_frontend.did.js';
export { idlFactory } from './proxy_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROXY_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proxy_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proxy_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proxy_frontend.did.js")._SERVICE>}
 */
export const proxy_frontend = createActor(canisterId);
